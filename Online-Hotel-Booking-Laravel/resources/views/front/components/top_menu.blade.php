        ...
        <div class="row" >
            <div class="top-bar">
                <ul style="background-color: mediumseagreen;">
                    <li><a href="#" style="color:white">Phone No:  {{ config('app.phone_number', '09123456789') }}</a>
                    </li>
                    <li><a class='dropdown-button' href='#' data-activates='dropdown1' style="color:white"> My Account <i
