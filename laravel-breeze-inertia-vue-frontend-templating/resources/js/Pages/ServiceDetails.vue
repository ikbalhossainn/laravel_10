                        ...
                        <div class="col-lg-8">
                            <div class="service-article">
                                <div class="service-article-img">
                                    <img
                                        src="assets/img/service-details-img.jpg"
                                        alt="Images"
                                    />
                                </div>
                                ...
                                <div class="service-article-title">
                                    <h2>
                                        Hotel Room Reservation into the Desire
                                        Places
                                    </h2>
                                </div>
                                            ...
                                            <div class="services-item">
                                                ...
                                                <h3>
                                                    <a
                                                        ...
                                                        >Resort Reservation Into
                                                        a Suitable Place</a
                                                    >
                                                </h3>
                                                <p>
                                                    One can easily reserve a
                                                    resort room in a suitable
                                                    place as you want. This will
                                            ...
                                            <div class="services-item">
                                                ...
                                                <h3>
                                                    <a
                                                        href="service-details.html"
                                                        >Book Now to Secure
                                                        Availability Time Now</a
                                                    >
                                                </h3>
                                                <p>
                                                    You can easily reserve a
                                                    hotel room in a suitable
                                                    place as you want. This will
                                                    be able to make good
                                                    feelings.
                                                </p>
                                ...
                                <div class="services-bar-widget">
                                    ...
                                    <div class="side-bar-categories">
                                        <ul>
                                            <li>
                                                <a href="#"
                                                    >Conference Rooms Related</a
                                                >
                                            </li>
                                            <li>
                                                <a href="#"
                                                    >Hotel Rooms Related</a
                                                >
                                            </li>
                                            <li>
                                                <a href="#"
                                            ...
                                            <li>
                                                <a href="#"
                                                    >Weeding Hall Related</a
                                                >
                                            </li>
                                            <li>
                                                <a href="#"
                                                    >Community Centre Related</a
                                                >
                                            </li>
                                        </ul>
                                    </div>
